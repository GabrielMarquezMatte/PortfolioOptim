...
namespace portfolio_optimizer::optimization
{
    ...
    private:
        ...
        OptimizationResult minimize_risk(const double wanted_return,const std::vector<double>& expected_returns, Matrix<double>& covariance,const std::vector<std::string>& tickers);
    public:
